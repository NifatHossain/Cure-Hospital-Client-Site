...
const AllTreatmentCards = () => {
  ...
  return (
    <div>
      <h2 className="text-3xl font-semibold border-l-8 border-blue-500 p-4 bg-blue-100 my-6 text-black">
        Our Treatments
      </h2>
      ...
      <div className="flex gap-4 md:gap-12 border-l-8 border-blue-500 p-4 bg-blue-100">
        <div>
            <h1 className="text-2xl font-bold text-black">We have World class Specialized Doctors</h1>
            <p className="text-lg font-medium text-black">Find All doctor here</p>
        </div>
