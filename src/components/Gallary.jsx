    ...
    return (
        <div className="my-5">
            ...
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full h-[30vh] md:h-[65vh]">
                ...
                <div id="slide2" className="carousel-item relative w-full h-[30vh] md:h-[65vh]">
                ...
                <div id="slide3" className="carousel-item relative w-full h-[30vh] md:h-[65vh]">
                ...
                <div id="slide4" className="carousel-item relative w-full h-[30vh] md:h-[65vh]">
